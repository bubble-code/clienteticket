...
const BotonesInicio = () => {
  ...
  return (    
    <div className="container-page-inicio-tec">
      <div className="grid-page-tec">
        ...
        {!isInicio ?
          <Card style={{ marginLeft: 20 }} bordered className="boton-inicio-ticket" onClick={setIniciarJornadas}>
